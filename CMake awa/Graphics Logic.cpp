...
int menu() {
	...
	buttons.push_back(Button(290, 250, 100, 50, _T("单人游戏")));
	buttons.push_back(Button(290, 350, 100, 50, _T("双人游戏")));
	buttons.push_back(Button(290, 450, 100, 50, _T("选项")));
	buttons.push_back(Button(290, 550, 100, 50, _T("退出游戏")));
